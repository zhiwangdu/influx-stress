...
// The following tokens represent the different values in the AST that make up IQL.
const (
	ILLEGAL Token = iota
	EOF
...
func (p *Parser) ParseTemplate() (*workload.Template, error) {

	// Blank template
	tmplt := &workload.Template{}
...
func (p *Parser) ParseFunction() (*workload.Function, error) {
...
func (p *Parser) ParseTimestamp() (*workload.Timestamp, error) {
