	...
	var tests = []struct {
...

		{
			...
			stmt: &statement.InsertStatement{
				...
				Templates: []*workload.Template{
					...
					&workload.Template{
						Function: &workload.Function{Type: "str", Fn: "rand", Argument: 7, Count: 1000},
					},
					&workload.Template{
						Function: &workload.Function{Type: "int", Fn: "rand", Argument: 1000, Count: 100},
					},
					&workload.Template{
						Function: &workload.Function{Type: "float", Fn: "rand", Argument: 10, Count: 0},
					},
				},
...

		{
			...
			stmt: &statement.InsertStatement{
				...
				Templates: []*workload.Template{
					&workload.Template{
						Function: &workload.Function{Type: "str", Fn: "rand", Argument: 1000, Count: 10},
					},
					&workload.Template{
						Tags: []string{"us-west", "us-east", "eu-north"},
					},
