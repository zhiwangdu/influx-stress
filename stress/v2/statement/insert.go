...
import (
	...
	"github.com/influxdata/influx-stress/stress/v2/stress_client"
)
...
func (i *InsertStatement) SetVars(s *stressClient.StressTest) chan<- string {
	...
	i.renderer = newPointRenderer(i.TemplateString, i.Templates, i.series, i.time)
...
func (i *InsertStatement) Run(s *stressClient.StressTest) {
	...
	buf := newBatchBuffer(i.renderer, s.BatchSize)
